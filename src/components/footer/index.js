...
class Footer extends Component {
  render () {
    ...
    return (
      <footer className={`${prefixClass}-site-footer`}>
        <div>
          <div className={`${prefixClass}-site-footer-inner`}>
            <div className={`${prefixClass}-footer-brand`}>
              <a href="#">
                <title>Adify</title>
              </a>
            </div>
            <ul className={`${prefixClass}-footer-links ${prefixClass}-list-reset`}>
              <li>
                <a href="#">Contact</a>
              </li>
              <li>
            ...
            <ul className={`${prefixClass}-footer-social-links ${prefixClass}-list-reset`}>
              <li>
                <a href="#">
            ...
            <div className={`${prefixClass}-footer-copyright text-light`}>&copy; 2018 Adify | all rights reserved</div>
          </div>
        </div>
      </footer>
    );
